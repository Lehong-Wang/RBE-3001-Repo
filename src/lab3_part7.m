...
% P1-P2
TP1_2_1 = traj.quintic_traj(0, 2, 0, 0, 50.0078, 50.0121, 0, 0);
TP1_2_2 = traj.quintic_traj(0, 2, 0, 0, 55.0157, 0, 0, 0);
TP1_2_3 = traj.quintic_traj(0, 2, 0, 0, 75.0092, 34.995, 0, 0);
TPC1 = [TP1_2_1; TP1_2_2; TP1_2_3];
robot.run_trajectory(TPC1, 2, 0);
% P2-P3
TP2_3_1 = traj.quintic_traj(2, 4, 0, 0, 50.0121, 140.0096, 0, 0);
TP2_3_2 = traj.quintic_traj(2, 4, 0, 0, 0, 59.9793, 0, 0);
TP2_3_3 = traj.quintic_traj(2, 4, 0, 0, 34.995, 90.0004, 0, 0);
TPC2 = [TP2_3_1; TP2_3_2; TP2_3_3];
robot.run_trajectory(TPC2, 2, 0);
% P3-P1
TP3_1_1 = traj.quintic_traj(4, 6, 0, 0, 140.0096, 50.0078, 0, 0);
TP3_1_2 = traj.quintic_traj(4, 6, 0, 0, 59.9793, 55.0157, 0, 0);
TP3_1_3 = traj.quintic_traj(4, 6, 0, 0, 90.0004, 75.0092, 0, 0);
...
% plot Velocity along each axis vs. Time
subplot(2, 2, 2)
...
% plot 3d trajectory
figure
plot3(eePosArray(:,1),eePosArray(:,2),eePosArray(:,3))
